...
mean(meanaicc_oumva_BMS_sim) #291.0797,286.1763

meanaicc_oumva_OU1_sim<-t(sapply(oumva_OU1_sim,function(x) x$AICc))
meanaicc_oumva_OU1_sim
mean(meanaicc_oumva_OU1_sim) #291.0797,286.1763,232.366

meanaicc_oumva_OUM_sim<-t(sapply(oumva_OUM_sim,function(x) x$AICc))
meanaicc_oumva_OUM_sim
mean(meanaicc_oumva_OUM_sim) #291.0797,286.1763,232.366,228.6443

meanaicc_oumva_OUMV_sim<-t(sapply(oumva_OUMV_sim,function(x) x$AICc))
meanaicc_oumva_OUMV_sim
mean(meanaicc_oumva_OUMV_sim) # 291.0797,286.1763,232.366,228.6443,226.2742

meanaicc_oumva_OUMVA_sim<-t(sapply(oumva_OUMVA_sim,function(x) x$AICc))
meanaicc_oumva_OUMVA_sim
mean(meanaicc_oumva_OUMVA_sim) #291.0797,286.1763,232.366,228.6443,226.2742,-50070509555


sim_oumva<-c(291.0797,286.1763,232.366,228.6443,226.2742,-50070509555)
akaike.weights(sim_oumva)
