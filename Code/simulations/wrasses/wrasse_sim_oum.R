...
#making simulated dtaa and new data frames
#OUM
...
mean(meanaicc_oum_OUMVA_sim) #148.4085,147.5537,124.8072 ,107.1089,109.1171,-50108944476 nope...



sim_oum<- c(148.4085,147.5537,124.8072 ,107.1089,109.1171,-50108944476)
akaike.weights(sim_oum)
