...
mean(meanaicc_oumv_BMS_sim_ms) # 91.30437,90.42694

meanaicc_oumv_OU1_sim_ms<-t(sapply(oumv_OU1_sim_ms,function(x) x$AICc))
meanaicc_oumv_OU1_sim_ms
mean(meanaicc_oumv_OU1_sim_ms) #91.30437,90.42694,86.43928

meanaicc_oumv_OUM_sim_ms<-t(sapply(oumv_OUM_sim_ms,function(x) x$AICc))
meanaicc_oumv_OUM_sim_ms
mean(meanaicc_oumv_OUM_sim_ms) #91.30437,90.42694,86.43928,76.43124 ##this should not be the case

meanaicc_oumv_OUMV_sim_ms<-t(sapply(oumv_OUMV_sim_ms,function(x) x$AICc))
meanaicc_oumv_OUMV_sim_ms
mean(meanaicc_oumv_OUMV_sim_ms) #91.30437,90.42694,86.43928,76.43124,79.13219  ####oum does better????

meanaicc_oumv_OUMVA_sim_ms<-t(sapply(oumv_OUMVA_sim_ms,function(x) x$AICc))
meanaicc_oumv_OUMVA_sim_ms
mean(meanaicc_oumv_OUMVA_sim_ms) #91.30437,90.42694,86.43928,76.43124,79.13219,-884.3681????

sim_oumv_ms<- c(91.30437,90.42694,86.43928,76.43124,79.13219,-884.3681)
akaike.weights(sim_oumv_ms)
