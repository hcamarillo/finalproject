...
mean(meanaicc_bm1_BMS_sim_ms) #183.36,185.3559

meanaicc_bm1_OU1_sim_ms<-t(sapply(bm1_OU1_sim_ms,function(x) x$AICc))
meanaicc_bm1_OU1_sim_ms
mean(meanaicc_bm1_OU1_sim_ms) #183.36,185.3559,185.7876

meanaicc_bm1_OUM_sim_ms<-t(sapply(bm1_OUM_sim_ms,function(x) x$AICc))
meanaicc_bm1_OUM_sim_ms
mean(meanaicc_bm1_OUM_sim_ms) #183.36,185.3559,185.7876,188.2847

meanaicc_bm1_OUMV_sim_ms<-t(sapply(bm1_OUMV_sim_ms,function(x) x$AICc))
meanaicc_bm1_OUMV_sim_ms
mean(meanaicc_bm1_OUMV_sim_ms) #183.36,185.3559,185.7876,188.2847,190.647

meanaicc_bm1_OUMVA_sim_ms<-t(sapply(bm1_OUMVA_sim_ms,function(x) x$AICc))
meanaicc_bm1_OUMVA_sim_ms
mean(meanaicc_bm1_OUMVA_sim_ms) #183.36,185.3559,185.7876,188.2847,190.647,190.4572

sim_bm1_ms<- c(183.36,185.3559,185.7876,188.2847,190.647,190.4572)
