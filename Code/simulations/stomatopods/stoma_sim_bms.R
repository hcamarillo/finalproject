...
mean(meanaicc_bms_BMS_sim_ms) #204.3592,204.333

meanaicc_bms_OU1_sim_ms<-t(sapply(bms_OU1_sim_ms,function(x) x$AICc))
meanaicc_bms_OU1_sim_ms
mean(meanaicc_bms_OU1_sim_ms) #204.3592,204.333,206.7868

meanaicc_bms_OUM_sim_ms<-t(sapply(bms_OUM_sim_ms,function(x) x$AICc))
meanaicc_bms_OUM_sim_ms
mean(meanaicc_bms_OUM_sim_ms) #204.3592,204.333,206.7868,209.1473

meanaicc_bms_OUMV_sim_ms<-t(sapply(bms_OUMV_sim_ms,function(x) x$AICc))
meanaicc_bms_OUMV_sim_ms
mean(meanaicc_bms_OUMV_sim_ms) # 204.3592,204.333,206.7868,209.1473,209.484

meanaicc_bms_OUMVA_sim_ms<-t(sapply(bms_OUMVA_sim_ms,function(x) x$AICc))
meanaicc_bms_OUMVA_sim_ms
mean(meanaicc_bms_OUMVA_sim_ms) #204.3592,204.333,206.7868,209.1473,209.484,211.9325

sim_bms_ms<- c(204.3592,204.333,206.7868,209.1473,209.484,211.9325)
akaike.weights(sim_bms_ms)
