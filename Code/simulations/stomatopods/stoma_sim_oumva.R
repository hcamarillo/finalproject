...
mean(meanaicc_oumva_BMS_sim_ms) #102.8744,98.23815

meanaicc_oumva_OU1_sim_ms<-t(sapply(oumva_OU1_sim_ms,function(x) x$AICc))
meanaicc_oumva_OU1_sim_ms
mean(meanaicc_oumva_OU1_sim_ms) #102.8744,98.23815,100.2095

meanaicc_oumva_OUM_sim_ms<-t(sapply(oumva_OUM_sim_ms,function(x) x$AICc))
meanaicc_oumva_OUM_sim_ms
mean(meanaicc_oumva_OUM_sim_ms) #102.8744,98.23815,100.2095,89.38316

meanaicc_oumva_OUMV_sim_ms<-t(sapply(oumva_OUMV_sim_ms,function(x) x$AICc))
meanaicc_oumva_OUMV_sim_ms
mean(meanaicc_oumva_OUMV_sim_ms) #102.8744,98.23815,100.2095,89.38316,76.61978

meanaicc_oumva_OUMVA_sim_ms<-t(sapply(oumva_OUMVA_sim_ms,function(x) x$AICc))
meanaicc_oumva_OUMVA_sim_ms
mean(meanaicc_oumva_OUMVA_sim_ms) #102.8744,98.23815,100.2095,89.38316,76.61978,-2905.722

sim_oumva_ms<-c(102.8744,98.23815,100.2095,89.38316,76.61978,-2905.722)
akaike.weights(sim_oumva_ms)